...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.x = clamp(0, boy.x ,server.background.w - 50 -1 )
        boy.y = clamp(0, boy.y ,server.background.h + 50 -1)
    ...
    def draw(boy):
        ...
        # boy.font.draw(sx + 40, sy + 100, '(%d)' % (Ball.count), (255,255,0))
        boy.font.draw(sx + 40, sy + 100, '(%d)' % (Ball.count_ball(Ball)), (255,255,0))
